...
def load_model(model_path, device='cuda:0', precision='bf16'):
    ...
    llama_config = config_class.from_pretrained(model_path,local_files_only=True)
    model = model_class.from_pretrained(model_path, config=llama_config, local_files_only=True)
